...
public class TestingAIBasic01 : MonoBehaviour
{
    private Blackboard blackboard;
    private Root behaviorTree;

    public float maxDistToPlayer = 7.5f;
        ...
        return new Root(
            ...
            new Service(0.125f, UpdatePlayerDistance,
                ...
                new Selector(
                    ...
                    new BlackboardCondition("playerDistance", Operator.IS_SMALLER, maxDistToPlayer, Stops.IMMEDIATE_RESTART,
    ...
    private void UpdatePlayerDistance()
    {
        ...
        behaviorTree.Blackboard["playerTrasform"] = playerTransform;
    ...
    private void MoveTowards(Vector3 localPosition)
    {
        ...
        this.GetComponent<AICharacterControl>().SetTarget( blackboard.Get<Transform>("playerTrasform"));
    }
